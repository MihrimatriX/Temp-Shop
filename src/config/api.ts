...
export const API_ENDPOINTS = {
  ...
  DISCOUNTED_PRODUCTS: () => `${getProductEndpoint()}/discounted`,
      ...
      SUBCATEGORIES_BY_CATEGORY: (categoryId: number) => `${getSubCategoryEndpoint()}/category/${categoryId}`,
  ...
  PRODUCT_REVIEWS: (productId: number) => `${getReviewEndpoint()}/product/${productId}`,
