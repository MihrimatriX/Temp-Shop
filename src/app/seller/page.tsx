...
const successStories = [
  {
    ...
    period: "aylık",
    story:
      "Platform sayesinde satışlarım 5 kat arttı. Müşteri kitlesi genişledi ve işim büyüdü.",
  ...
  },
  {
    ...
    period: "aylık",
    story:
      "Düşük komisyon oranları sayesinde daha fazla kar elde ediyorum. Platform çok profesyonel.",
  ...
  },
  {
    ...
    period: "aylık",
    story:
      "Müşteri desteği harika. Satış sonrası sorunları hızlıca çözüyorlar.",
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-center mb-8">
            Neden Bizimle Satış Yapmalısınız?
          </h2>
