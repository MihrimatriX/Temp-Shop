...
const testimonials = [
  {
    ...
    rating: 5,
    comment:
      "Premium üyelik gerçekten fark yaratıyor. Hızlı teslimat ve özel indirimler harika!",
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "Ücretsiz kargo ve özel indirimler sayesinde çok tasarruf ediyorum.",
      ...
      <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl opacity-90 max-w-3xl mx-auto">
            Premium olun, farkı yaşayın. Özel indirimler, hızlı teslimat ve VIP
            destek ile alışveriş deneyiminizi üst seviyeye taşıyın.
          </p>
        </div>
      </div>
              ...
              return (
                ...
                >
                  <CardContent className="p-6">
                    <div
                      className={`w-16 h-16 mx-auto mb-4 rounded-full ${benefit.bgColor} flex items-center justify-center`}
                    >
            ...
            {[
              {
                ...
                answer:
                  "Premium üyeliğinizi istediğiniz zaman hesap ayarlarınızdan iptal edebilirsiniz. İptal işlemi sonrası üyelik süreniz bitene kadar avantajlardan yararlanmaya devam edersiniz.",
              },
              {
                question: "Premium üyelik avantajları ne zaman aktif olur?",
                answer:
                  "Premium üyelik satın aldığınız anda tüm avantajlar aktif hale gelir. Özel indirimler, ücretsiz kargo ve diğer avantajlardan hemen yararlanabilirsiniz.",
              },
              {
                question: "Premium üyelik otomatik yenilenir mi?",
                answer:
                  "Evet, premium üyelik otomatik olarak yenilenir. İptal etmek istemiyorsanız hiçbir işlem yapmanıza gerek yoktur.",
              },
              {
                question:
                  "Premium üyelik avantajları tüm ürünlerde geçerli mi?",
                answer:
                  "Premium üyelik avantajları çoğu üründe geçerlidir. Bazı özel kampanyalar ve indirimli ürünlerde ek indirim uygulanmayabilir.",
              },
            ].map((faq, index) => (
              <Card key={index}>
                <CardHeader>
