...
const entrepreneurStories = [
  {
    ...
    story:
      "5 yıl önce küçük bir atölyede başladığım seramik yolculuğum, bugün 50'den fazla kadına istihdam sağlıyor. Geleneksel teknikleri modern tasarımla buluşturarak, her parçada bir hikaye anlatıyoruz.",
    achievements: [
      "50+ kadın istihdamı",
      "3 uluslararası ödül",
      "15 ülkeye ihracat",
  ...
  },
  {
    ...
    story:
      "Çocuklarımın hassas cildi için başladığım doğal sabun üretimi, bugün binlerce ailenin tercihi haline geldi. Kimyasal içermeyen, tamamen doğal ürünler üretiyoruz.",
    achievements: [
      "100% doğal ürün",
      "Çevre dostu ambalaj",
  ...
  },
  {
    ...
    story:
      "Büyükannemden öğrendiğim örgü tekniklerini modern tasarımlarla buluşturarak, her mevsim şık ve sıcak ürünler üretiyorum. Her parça sevgiyle örülüyor.",
    achievements: [
      "Geleneksel teknik korunuyor",
      "Sürdürülebilir moda",
      "Yerel işçilik",
    ],
    products: 62,
...
const benefits = [
  {
    ...
    description:
      "Kadın girişimcileri destekleyerek toplumsal dayanışmayı güçlendiriyoruz",
  },
  {
    icon: Award,
  ...
  },
  {
    ...
    description:
      "Kadın istihdamını artırarak toplumsal kalkınmaya katkı sağlıyoruz",
  },
  {
    icon: TrendingUp,
    title: "Sürdürülebilir Büyüme",
    description:
      "Çevre dostu ve sürdürülebilir üretim modellerini destekliyoruz",
  },
];
      ...
      <div className="bg-gradient-to-r from-pink-600 to-purple-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl opacity-90 max-w-3xl mx-auto">
            Kadın girişimcilerin hikayelerini keşfedin, el yapımı ürünleri satın
            alın. Kadın dayanışması ile güçlü bir toplum inşa ediyoruz.
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-center mb-8">
            Neden Kadın Girişimcileri Destekliyoruz?
          </h2>
            ...
            {entrepreneurProducts.map((product) => (
              ...
              >
                ...
                <CardHeader>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {product.entrepreneur} - {product.business}
                  </p>
            ...
            {specialCampaigns.map((campaign) => (
              ...
              >
                <div className="relative">
                  ...
                  <div className="absolute top-4 right-4">
                    <Badge variant="secondary">{campaign.timeLeft}</Badge>
                  </div>
                </div>
                ...
                <CardContent>
                  ...
                  <Button className="w-full">Kampanyayı Gör</Button>
                </CardContent>
              </Card>
            ))}
          </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-center">
                Kadın Girişimci İstatistikleri
              </CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <section className="bg-gradient-to-r from-pink-600 to-purple-600 text-white rounded-lg p-8 text-center">
          ...
          <p className="text-xl opacity-90 mb-6">
            El yapımı, doğal ve kaliteli ürünlerle kadın dayanışmasını
            güçlendirin
          </p>
