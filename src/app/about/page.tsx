...
export const metadata: Metadata = {
  ...
  description: 'E-ticaret sitemiz hakkında bilgi edinin. Misyonumuz, vizyonumuz ve değerlerimiz.',
}
...
const values = [
  {
    ...
    description: 'Müşterilerimizin memnuniyeti bizim önceliğimizdir. Her zaman en iyi hizmeti sunmaya çalışıyoruz.'
  },
  {
    icon: Globe,
    title: 'Kaliteli Ürünler',
    description: 'Sadece kaliteli ve güvenilir ürünleri sizlere sunuyoruz. Tüm ürünlerimiz titizlikle seçilmiştir.'
  },
  {
    icon: Target,
    title: 'Hızlı Teslimat',
    description: 'Siparişlerinizi en kısa sürede kapınıza getiriyoruz. Hızlı ve güvenli teslimat garantisi.'
  },
  {
    icon: Lightbulb,
    title: 'İnovasyon',
    description: 'Sürekli gelişim ve yenilik anlayışıyla e-ticaret deneyimini daha da iyileştiriyoruz.'
  }
]
      ...
      <div className="bg-gradient-to-r from-purple-600 to-purple-800 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl opacity-90 max-w-3xl mx-auto">
            Türkiye'nin en güvenilir e-ticaret platformu olarak, 
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          <div>
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                2020 yılında kurulan şirketimiz, e-ticaret sektöründe müşteri memnuniyetini 
                ön planda tutan bir anlayışla faaliyet göstermektedir.
              </p>
              <p>
                Başlangıçta küçük bir ekip olarak başladığımız yolculuğumuzda, 
                bugün binlerce müşteriye hizmet veren büyük bir platform haline geldik.
              </p>
              <p>
          ...
          <div className="bg-gradient-to-br from-purple-100 to-purple-200 rounded-lg p-8">
            ...
            <p className="text-muted-foreground mb-6">
              ...
              en hızlı şekilde ulaştırmak ve mükemmel bir alışveriş deneyimi yaşatmak.
            </p>
            ...
            <p className="text-muted-foreground">
              ...
              teknoloji ve inovasyonla sektöre yön vermek.
            </p>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">En İyi E-Ticaret Sitesi</h3>
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">Güvenli Alışveriş Ödülü</h3>
                <Badge variant="secondary">2023</Badge>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">Hızlı Teslimat Ödülü</h3>
                <Badge variant="secondary">2023</Badge>
              </CardContent>
            </Card>
          </div>
