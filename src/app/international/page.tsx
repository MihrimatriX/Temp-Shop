    ...
    <div className="min-h-screen">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Yurt Dışından Alışveriş</h1>
          <p className="text-xl md:text-2xl opacity-90 max-w-3xl mx-auto">
            Dünyanın dört bir yanından en kaliteli ürünleri keşfedin. 
            Gümrük ve kargo işlemleri bizim sorumluluğumuzda.
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-center mb-8">Neden Yurt Dışından Alışveriş?</h2>
        ...
        <section className="mb-12">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold">Öne Çıkan Uluslararası Ürünler</h2>
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-3">Teslimat Süreleri</h3>
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li className="flex items-center gap-2">
                      <CheckCircle className="w-4 h-4 text-green-500" />
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4">
            {[
              {
                question: "Yurt dışından alışveriş yaparken ek vergi öder miyim?",
                answer: "Hayır, tüm gümrük vergileri ve ek vergiler fiyata dahildir. Siz sadece ürün fiyatını ödersiniz."
              },
              {
                question: "Teslimat süresi ne kadar?",
                answer: "Teslimat süresi ülkeye göre değişir. ABD'den 5-10 gün, Avrupa'dan 6-9 gün, Asya'dan 8-14 gün sürmektedir."
              },
              {
                question: "Ürün hasarlı gelirse ne yapmalıyım?",
                answer: "Ürün hasarlı gelirse 7 gün içinde müşteri hizmetlerimizle iletişime geçin. Ücretsiz değişim veya iade yapılır."
              },
              {
                question: "Hangi ödeme yöntemlerini kullanabilirim?",
                answer: "Kredi kartı, banka kartı, havale/EFT ve taksit seçenekleri ile ödeme yapabilirsiniz."
              },
            ].map((faq, index) => (
              <Card key={index}>
                <CardHeader>
