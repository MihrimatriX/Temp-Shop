    ...
    questions: [
      {
        ...
        answer:
          "Siparişleriniz genellikle 1-3 iş günü içinde kargoya verilir. Teslimat süresi bölgenize göre 1-5 iş günü arasında değişir.",
      },
      {
        question: "Siparişimi nasıl takip edebilirim?",
        answer:
          "Sipariş takip numaranızı e-posta ile alacaksınız. Bu numarayı kargo firmasının web sitesinde sorgulayabilirsiniz.",
      },
      {
        question: "Ücretsiz kargo limiti nedir?",
        answer:
          "150 TL ve üzeri alışverişlerde ücretsiz kargo hizmeti sunuyoruz.",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "E-fatura sistemimiz üzerinden faturanızı e-posta adresinize gönderebiliriz.",
      },
      {
        question: "Taksit seçenekleri nelerdir?",
        answer:
          "2-12 taksit arası seçeneklerimiz bulunmaktadır. Taksit sayısı kartınıza göre değişir.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer:
          "14 gün içinde ürünü orijinal ambalajında iade edebilirsiniz. İade formu ile birlikte kargo ile gönderebilirsiniz.",
      },
      {
        question: "İade ücreti kim karşılar?",
        answer:
          "Ürün hatası varsa iade ücretini biz karşılarız. Müşteri kaynaklı iadelerde kargo ücreti müşteriye aittir.",
      },
      {
        question: "İade süreci ne kadar sürer?",
        answer:
          "İade edilen ürün kontrol edildikten sonra 3-5 iş günü içinde ödeme işleminiz gerçekleştirilir.",
      },
    ],
  },
];
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl opacity-90 max-w-3xl mx-auto">
            Size nasıl yardımcı olabiliriz? 7/24 müşteri desteği ile
            yanınızdayız.
          </p>
        </div>
      </div>
        ...
        <section className="mb-12">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="relative w-64">
              ...
              <Input placeholder="Sorunuzu arayın..." className="pl-10" />
            </div>
          </div>
