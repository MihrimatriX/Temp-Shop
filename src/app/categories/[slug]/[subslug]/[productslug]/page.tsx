...
export async function generateMetadata({
  ...
  if (category && !subcategory) {
    ...
    if (dyn) {
      subcategory = { slug: dyn.slug, name: dyn.name };
    }
  }
  ...
  return {
    ...
    alternates: {
      canonical: `https://tempshop.com/categories/${slugNorm}/${subslug}/${productslug}`,
    },
  };
}
...
export default async function ProductPage({ params }: ProductPageProps) {
  ...
  if (category && !subcategory && menuResolved) {
    subcategory = { slug: menuResolved.slug, name: menuResolved.name };
  }
      ...
      <div className="container mx-auto px-4 py-8">
        <Breadcrumb
          items={[
            ...
            {
              label: productName,
              href: `/categories/${category.slug}/${subcategory.slug}/${productslug}`,
            },
          ]}
        />
          ...
          <div className="flex items-center gap-4 mb-4">
            <div>
              ...
              <p className="text-xl opacity-90">
                {subcategory.name} kategorisinde {categoryProducts.length} ürün
                bulundu
              </p>
            </div>
          </div>
        ...
        <div className="mb-8">
          <p className="text-muted-foreground mb-4">
            {category.name} &gt; {subcategory.name} &gt; {productName}{" "}
