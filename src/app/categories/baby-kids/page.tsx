...
export const metadata: Metadata = {
  ...
  description:
    "Bebek ve çocuk giyim, oyuncak, bakım ürünleri ve anne ihtiyaçları. Güvenli ve kaliteli ürünler!",
  keywords: [
    "bebek giyim",
    "çocuk giyim",
    "bebek bakım",
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <CategoryHeader
        ...
        imageUrl={
          category.imageUrl || "https://picsum.photos/800/600?random=baby-kids"
        }
      />
