...
export const metadata: Metadata = {
  ...
  description:
    "Sneaker, klasik, bot, spor ve daha fazlası. Erkek ayakkabı modelleri ile stilinizi tamamlayın!",
  keywords: [
    "erkek ayakkabı",
    "sneaker",
    "klasik",
    "bot",
    "spor",
    "erkek ayakkabı modelleri",
  ],
  openGraph: {
    title: "Erkek Ayakkabı | TempShop",
    description:
      "Sneaker, klasik, bot, spor ve daha fazlası. Erkek ayakkabı modelleri ile stilinizi tamamlayın!",
    url: "https://tempshop.com/categories/shoes-bags/men-shoes",
...
export default function MenShoesPage() {
  ...
  const subCategory = getSubCategoryByName(
    "Erkek Ayakkabı",
    "Ayakkabı & Çanta",
  );
