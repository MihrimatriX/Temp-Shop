...
export const metadata: Metadata = {
  ...
  description:
    "Kadın ve erkek ayakkabı, çanta, bavul ve aksesuar ürünleri. Stilinizi tamamlayın!",
  keywords: [
    "ayakkabı",
    "çanta",
    "bavul",
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <CategoryHeader
        ...
        imageUrl={
          category.imageUrl || "https://picsum.photos/800/600?random=shoes-bags"
        }
      />

      <section className="mt-12">
        <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">
          Ayakkabı & Çanta Ürünleri
        </h2>
