...
export const metadata: Metadata = {
  ...
  description:
    "Topuklu, babet, sneaker, bot, çizme ve daha fazlası. Kadın ayakkabı modelleri ile stilinizi tamamlayın!",
  keywords: [
    "kadın ayakkabı",
    "topuklu",
    "babet",
  ...
  openGraph: {
    ...
    description:
      "Topuklu, babet, sneaker, bot, çizme ve daha fazlası. Kadın ayakkabı modelleri ile stilinizi tamamlayın!",
    url: "https://tempshop.com/categories/women/shoes",
...
export default function WomenShoesPage() {
  ...
  const subCategory = getSubCategoryByName("Ayakkabı", "Kadın");
  const products = getProductsByCategoryAndSubCategory("Kadın", "Ayakkabı");

  if (!category || !subCategory) {
    return (
      <div className="container mx-auto px-4 py-8 text-center">
        Kategori veya alt kategori bulunamadı.
      </div>
    );
  }
