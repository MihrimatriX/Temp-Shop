...
export const metadata: Metadata = {
  ...
  description:
    "En şık kadın giyim ürünleri, trend ayakkabılar ve modern aksesuarlar. Tarzınızı yansıtan parçaları keşfedin!",
  keywords: [
    "kadın giyim",
    "kadın ayakkabı",
    "kadın çanta",
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <CategoryHeader
        ...
        imageUrl={
          category.imageUrl || "https://picsum.photos/800/600?random=women"
        }
      />
