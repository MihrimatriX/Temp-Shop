                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                      ...
                      <ul className="text-xs text-blue-700 mt-1 space-y-1">
                        ...
                        <li>
                          • Kişisel bilgilerinizi şifre olarak kullanmayın
                        </li>
                      </ul>
                    </div>
                ...
                <CardContent>
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <Select
                        value={config.type}
                        onValueChange={(value: any) => setBackendType(value)}
                      >
                        <SelectTrigger>
                    ...
                    {config.type === "mock" && (
                      <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                        <p className="text-sm text-blue-800">
                          <strong>Not:</strong> Mock data modu aktif. Backend
                          bağlantısı test edilemez.
                        </p>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="p-4 border border-yellow-200 bg-yellow-50 rounded-lg">
                      ...
                      <p className="text-sm text-yellow-700 mb-3">
                        Hesabınızı geçici olarak dondurur. Daha sonra tekrar
