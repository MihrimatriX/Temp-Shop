...
const securityTips = [
  {
    ...
    description:
      "En az 8 karakter, büyük-küçük harf, sayı ve özel karakter içeren şifreler kullanın.",
    icon: Lock,
  },
  {
    title: "İki Faktörlü Doğrulama",
    description:
      "Hesabınıza ek güvenlik katmanı eklemek için 2FA'yı etkinleştirin.",
    icon: Smartphone,
  },
  {
    title: "Şüpheli Aktivite",
    description:
      "Tanımadığınız cihazlardan giriş yapıldığında hemen şifrenizi değiştirin.",
    icon: AlertTriangle,
  },
  {
