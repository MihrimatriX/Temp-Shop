...
const notifications = [
  {
    ...
    message:
      "ORD-123456 numaralı siparişiniz kargoya verildi. Takip numarası: 1234567890",
    type: "shipping",
    icon: Truck,
    isRead: false,
  ...
  },
  {
    ...
    message:
      "Elektronik ürünlerde %30'a varan indirimler başladı. Hemen keşfedin!",
    type: "campaign",
    icon: Gift,
    isRead: false,
  ...
  },
  {
    ...
    message:
      "Favorilerinizdeki 'iPhone 15 Pro Max' ürünü %15 indirimle satışta!",
    type: "favorite",
    icon: Star,
    isRead: true,
  ...
  },
  {
    ...
    message:
      "ORD-123455 numaralı siparişiniz başarıyla teslim edildi. Değerlendirmenizi bekliyoruz.",
    type: "delivery",
    icon: CheckCircle,
    isRead: true,
  ...
  },
  {
    ...
    message:
      "Hesabınızda yeni bir cihazdan giriş yapıldı. Eğer bu siz değilseniz, şifrenizi değiştirin.",
    type: "security",
    icon: AlertCircle,
    isRead: false,
  ...
  },
  {
    ...
    message:
      "Premium üyelik avantajlarından yararlanın. Ücretsiz kargo ve özel indirimler sizi bekliyor.",
    type: "premium",
    icon: Star,
    isRead: true,
  ...
  },
  {
    ...
    message:
      "Beğenebileceğiniz yeni ürünler keşfedin. Kişiselleştirilmiş önerilerimizi inceleyin.",
    type: "recommendation",
    icon: Gift,
    isRead: true,
                  ...
                  >
                    <CardContent className="p-6">
                      <div className="flex items-start gap-4">
                        <div
                          className={`w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center ${iconColor}`}
                        >
