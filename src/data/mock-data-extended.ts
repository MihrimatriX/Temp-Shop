...
export const extendedSubCategories: SubCategory[] = [
  ...
  {
    id: 21,
    subCategoryName: "Kadın Ayakkabı",
    categoryId: 8,
  ...
  {
    id: 41,
    subCategoryName: "Telefon & Tablet",
    categoryId: 4,
    categoryName: "Elektronik",
    isActive: true,
    createdAt: new Date(),
  ...
  {
    id: 31,
    subCategoryName: "Fitness & Kondisyon",
    categoryId: 4,
  ...
  {
    id: 43,
    subCategoryName: "Bebek Beslenme",
    categoryId: 5,
    categoryName: "Anne & Bebek",
    isActive: true,
    createdAt: new Date(),
  ...
  {
    id: 58,
    subCategoryName: "Vitamin & Takviye",
    categoryId: 6,
    categoryName: "Kozmetik & Kişisel Bakım",
    isActive: true,
    createdAt: new Date(),
  ...
  {
    id: 77,
    subCategoryName: "Çocuk Kitapları",
    categoryId: 8,
    categoryName: "Kitap & Müzik",
    isActive: true,
    createdAt: new Date(),
  ...
  {
    id: 83,
    subCategoryName: "Bahçe Aletleri",
    categoryId: 9,
    categoryName: "Oto & Bahçe",
    isActive: true,
    createdAt: new Date(),
  ...
  {
    id: 84,
    subCategoryName: "Bahçe Mobilyası",
    categoryId: 9,
    categoryName: "Oto & Bahçe",
    isActive: true,
    createdAt: new Date(),
  ...
  {
    id: 91,
    subCategoryName: "Ofis Malzemeleri",
    categoryId: 10,
    categoryName: "Kırtasiye & Ofis",
    isActive: true,
    createdAt: new Date(),
  ...
  {
    id: 92,
    subCategoryName: "Okul Kırtasiye",
    categoryId: 10,
    categoryName: "Kırtasiye & Ofis",
    isActive: true,
    createdAt: new Date(),
  ...
  {
    id: 93,
    subCategoryName: "Sanat Malzemeleri",
    categoryId: 10,
    categoryName: "Kırtasiye & Ofis",
    isActive: true,
    createdAt: new Date(),
  ...
  {
    id: 96,
    subCategoryName: "Yazı Malzemeleri",
    categoryId: 10,
    categoryName: "Kırtasiye & Ofis",
    isActive: true,
    createdAt: new Date(),
...
export const extendedCampaigns: Campaign[] = [
  {
    ...
    description:
      "Telefon, laptop, tablet ve diğer elektronik ürünlerde büyük indirimler. Sınırlı süre!",
    discount: 30,
  ...
  },
  {
    ...
    description:
      "Evinizi yenileyin! Mobilya, dekorasyon ve ev tekstili ürünlerinde indirimler.",
    discount: 20,
  ...
  },
  {
    ...
    description:
      "Sağlıklı yaşam için ihtiyacınız olan tüm spor ürünleri özel fiyatlarla.",
    discount: 35,
  ...
  },
  {
    ...
    description:
      "Bebeğiniz için en kaliteli ürünler özel fiyatlarla. Güvenli alışveriş garantisi.",
    discount: 40,
  ...
  },
  {
    ...
    description:
      "Makyaj, cilt bakımı ve kişisel bakım ürünlerinde büyük fırsatlar.",
    discount: 30,
  ...
  },
  {
    ...
    description:
      "Günlük ihtiyaçlarınız için en uygun fiyatlar. Hızlı teslimat.",
    discount: 20,
  ...
  },
  {
    ...
    description:
      "Okuma ve müzik tutkunları için özel fırsatlar. Yeni çıkan kitaplar ve albümler.",
    discount: 25,
  ...
  },
  {
    ...
    description:
      "Aracınız ve bahçeniz için ihtiyacınız olan tüm ürünler özel fiyatlarla.",
    discount: 30,
  ...
  },
  {
    ...
    description:
      "Ofis ve okul ihtiyaçlarınız için en uygun fiyatlar. Toplu alımlarda ek indirim.",
    discount: 35,
  ...
  },
  {
    ...
    description:
      "Black Friday fırsatları başladı! Tüm kategorilerde büyük indirimler.",
    discount: 50,
...
export const generateExtendedProducts = (): Product[] => {
  ...
  const fashionProducts = [
    ...
    "Converse All Star Kadın",
    "Vans Slip-On Kadın",
    "Puma Suede Kadın",
    "New Balance 574 Kadın",
    "Reebok Classic Kadın",
    "Fila Disruptor Kadın",
    "Skechers Go Walk Kadın",
    "Keds Champion Kadın",
    "Topuklu Ayakkabı Siyah",
    "Babet Ayakkabı Beyaz",
    "Sneaker Kadın Pembe",
    "Bot Kadın Kahverengi",
    "Çizme Kadın Siyah",
    "Sandalet Kadın Altın",
    "Loafer Kadın Siyah",
    "Spor Ayakkabı Kadın Mavi",
    "Platform Ayakkabı Kadın",
    "Oxford Kadın Siyah",

    // Erkek Ayakkabı
    "Nike Air Force 1 Erkek",
    "Adidas Stan Smith Erkek",
    "Converse All Star Erkek",
    "Vans Slip-On Erkek",
    "Puma Suede Erkek",
    "New Balance 574 Erkek",
    "Reebok Classic Erkek",
    "Fila Disruptor Erkek",
    "Skechers Go Walk Erkek",
    "Keds Champion Erkek",
    "Timberland 6 Inch",
    "Dr. Martens 1460",
    "Clarks Desert Boot",
    ...
    "Chaco Z/Cloud",
    "Sneaker Erkek Siyah",
    "Klasik Ayakkabı Erkek Kahverengi",
    "Spor Ayakkabı Erkek Beyaz",
    "Bot Erkek Siyah",
    "Terlik Erkek Mavi",
    ...
    "El Çantası Siyah",
    "Sırt Çantası Mavi",
    "Bel Çantası Kahverengi",
    "Omuz Çantası Beyaz",
    "Crossbody Çanta Siyah",
    "Laptop Çantası Siyah",
    "Spor Çantası Kırmızı",
    "Valiz Siyah",
    "Bavul Kahverengi",
    "Çanta Seti Çok Renkli",
    "Mini Çanta Pembe",
    "Büyük Çanta Siyah",
    "Deri Çanta Kahverengi",
    "Kumaş Çanta Mavi",
    "Plastik Çanta Şeffaf",
    "Coach Handbag",
    "Louis Vuitton Bag",
    "Gucci Belt",
    "Hermes Scarf",
  ...
  const anneCocukProducts = [
    ...
    "Gap Kids T-Shirt",
    "Old Navy Jeans",
    "Children's Place Dress",
    "OshKosh B'gosh",
    "Hanna Andersson Pajamas",
    "Mini Boden Shirt",
    "Janie and Jack Blouse",
    "Gymboree Pants",
    "Crazy 8 Shorts",
  ...
  allProducts.forEach((product, index) => {
    ...
    const finalDiscount =
      Math.random() > 0.7 ? Math.max(5, Math.floor(Math.random() * 30) + 5) : 0;
...
export const generateExtendedReviewSummaries = (
  products: Product[],
  reviews: Review[],
): ProductReviewSummary[] => {
...
export const getCategoryByName = (categoryName: string) => {
  return extendedCategories.find(
...
export const getSubCategoryByName = (
  ...
  return extendedSubCategories.find(
    (subCategory) =>
