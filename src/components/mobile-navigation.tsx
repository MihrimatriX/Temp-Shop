...
export function MobileNavigation({
  ...
  const [expandedAllCategories, setExpandedAllCategories] = useState<
    Set<string>
  >(new Set());
    ...
    <div className="lg:hidden">
      <Sheet open={isOpen} onOpenChange={setIsOpen}>
        ...
        <SheetContent side="left" className="w-80 sm:w-96 p-0">
          <SheetHeader className="p-4 pr-14 border-b border-border flex flex-row items-center justify-between space-y-0 text-left">
                        ...
                        <div className="ml-6 space-y-1 animate-in slide-in-from-top-1 duration-200">
                          {categorySubCategories.map((subCategory, index) => (
                            <Link
                              ...
                              onClick={handleLinkClick}
                            >
                              {"subCategoryName" in subCategory
