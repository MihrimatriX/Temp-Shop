      ...
      try {
        ...
        setDescriptionData({
          ...
          installmentOptions: [
            {
              months: 2,
              monthlyPayment: Math.round(product.unitPrice / 2),
              totalPrice: product.unitPrice,
              interest: 0,
            },
            {
              months: 3,
              monthlyPayment: Math.round(product.unitPrice / 3),
              totalPrice: product.unitPrice,
              interest: 0,
            },
            {
              months: 6,
              monthlyPayment: Math.round(product.unitPrice / 6),
              totalPrice: product.unitPrice,
              interest: 0,
            },
            {
              months: 9,
              monthlyPayment: Math.round(product.unitPrice / 9),
              totalPrice: product.unitPrice,
              interest: 0,
            },
            {
              months: 12,
              monthlyPayment: Math.round(product.unitPrice / 12),
              totalPrice: product.unitPrice,
              interest: 0,
            },
          ],
        ...
        <CardContent>
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground mb-4">
              Bu ürünü kredi kartınızla taksitli olarak satın alabilirsiniz. Tüm
              taksit seçenekleri faizsizdir.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Ürünümüz 2 yıl resmi garanti kapsamındadır. Garanti
                  kapsamındaki arızalar ücretsiz onarılır.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
