        ...
        {personalizedProducts.map((product) => (
          <div key={product.id} className="relative group">
            ...
            <Button
              variant="ghost"
              size="icon"
              className="absolute top-2 right-2 w-8 h-8 bg-background/90 hover:bg-background border border-border opacity-0 group-hover:opacity-100 transition-opacity"
            >
