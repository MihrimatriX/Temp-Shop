            ...
            <CardContent className="p-6">
                ...
                <div className="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
                  ...
                  <div className="text-right">
                    <div className="text-sm font-semibold text-blue-600">
                      {Math.round(discountedPrice / 2).toLocaleString("tr-TR", {
                        style: "currency",
                        currency: "TRY",
                      })}{" "}
                      x 2 taksit
                ...
                <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg">
                  ...
                  <div className="text-right">
                    <div className="text-sm font-semibold text-green-600">
                      {Math.round(discountedPrice / 3).toLocaleString("tr-TR", {
                        style: "currency",
                        currency: "TRY",
                      })}{" "}
                      x 3 taksit
                ...
                <div className="flex justify-between items-center p-3 bg-orange-50 rounded-lg">
                  ...
                  <div className="text-right">
                    <div className="text-sm font-semibold text-orange-600">
                      {Math.round(discountedPrice / 6).toLocaleString("tr-TR", {
                        style: "currency",
                        currency: "TRY",
                      })}{" "}
                      x 6 taksit
                ...
                <div className="flex justify-between items-center p-3 bg-purple-50 rounded-lg">
                  ...
                  <div className="text-right">
                    <div className="text-sm font-semibold text-purple-600">
                      {Math.round(discountedPrice / 9).toLocaleString("tr-TR", {
                        style: "currency",
                        currency: "TRY",
                      })}{" "}
                      x 9 taksit
                ...
                <div className="flex justify-between items-center p-3 bg-red-50 rounded-lg">
                  ...
                  <div className="text-right">
                    <div className="text-sm font-semibold text-red-600">
                      {Math.round(discountedPrice / 12).toLocaleString(
                        "tr-TR",
              ...
              <div className="mt-4 p-3 bg-gray-50 rounded-lg">
                <p className="text-xs text-muted-foreground">
                  <strong>Not:</strong> Taksit seçenekleri kredi kartı türüne
                  göre değişiklik gösterebilir. Detaylı bilgi için bankanızla
                  iletişime geçiniz.
                </p>
              </div>
            </CardContent>
